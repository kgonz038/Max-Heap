# Max-Heap
This program uses random integers in an array to create a max heap for the Priority Queue. It will display the raw data in un-organized random order. Then it will display the same numbers in organized max heap order after it passes through the method to organize it to max heap. It will also display the heap's max element (the root) as well as extracting/removing the max from the heap and displaying the new remaining and re-organized max heap.

<img src="maxheap-project.jpg">


## [Java file](https://github.com/kgonz038/Max-Heap/blob/main/Max_Heap_Project.java)
